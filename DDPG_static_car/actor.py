...
class Actor:
    ...
    def network(self):
        ...
        #
        x = Dense(400, kernel_initializer=RandomUniform(minval=-0.1, maxval=0.1))(inp)
        ...
        out = Dense(self.act_dim, activation='tanh', kernel_initializer=RandomUniform(minval=-0.03, maxval=0.03))(x)
